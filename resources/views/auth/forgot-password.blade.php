    ...
    <div class="d-flex align-items-center justify-content-center ht-100v">
      ...
      <div class="overlay-body bg-black-7 d-flex align-items-center justify-content-center">
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 rounded bg-black-6">
          <div class="signin-logo tx-center tx-28 tx-bold tx-white"><span class="tx-normal"></span> Forgot Password <span class="tx-info">?</span> <span class="tx-normal"></span></div>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <button class=" form control btn btn-dark ">Email Password Reset Link</button>
